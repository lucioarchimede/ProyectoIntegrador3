...
class EnCarteleraCard extends Component {
  ...
  render() {
    ...
    return (
      <div className='card-pelis'>
        ...
        <img src={`https://api.themoviedb.org/3/movie/now_playing${this.props.data.poster_path}`} alt={`${this.props.data.original_title}`} />
...
export default EnCarteleraCard